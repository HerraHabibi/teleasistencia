            ...
            <table class="custom-table" width="880px" border="0" class="index">
                <tbody>
                    <tr class="custom-row">
                        ...
                        <td class="custom-cell">
                            <a href="{{ route('gestion.actualizar') }}" class="click">
                                <img src="{{ asset('images/editar-usuario.png') }}" alt="Llamadas Entrantes" border="0" class="img-index">
            ...
            <table class="custom-table" width="880px" border="0" class="index">
                <tbody>
                    <tr class="custom-row">
                        ...
                        <td class="custom-cell">
                            <a href="{{route('gestion.contactos.buscar.mod')}}" class="click">
                                <img src="{{ asset('images/modificar-contacto.png') }}" alt="Contactos" border="0" class="img-index">
