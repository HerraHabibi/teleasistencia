...
<div class="d-flex align-items-center justify-content-between px-3 titulo">
    <div class="flex-shrink-0">
        <a href="{{ route('gestion.actualizar') }}" class="btn btn-link text-decoration-none p-0">
...
<div class="container-fluid mt-3">
    ...
    <form method="POST" action="{{ route('gestion.actualizar.beneficiario', $beneficiario->id) }}" enctype="multipart/form-data" class="bg-white p-4 rounded shadow-sm formulario">
        @csrf
        @method('PUT')
        <div class="row g-3">
            <div class="col-md-6">
                <label for="nombre" class="form-label">Nombre</label>
                <input type="text" id="nombre" name="nombre" class="form-control" value="{{ $beneficiario->nombre }}" placeholder="Nombre" required>
            </div>
            <div class="col-md-6">
                <label for="apellidos" class="form-label">Apellidos</label>
                <input type="text" id="apellidos" name="apellidos" class="form-control" value="{{ $beneficiario->apellidos }}" placeholder="Apellidos" required>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <input type="email" id="email" name="email" class="form-control" value="{{ $beneficiario->email }}" placeholder="ejemplo@gmail.com" required>
            </div>
            <div class="col-md-6">
                <label for="fecha_nacimiento" class="form-label">Fecha de nacimiento</label>
                <input type="date" id="fecha_nacimiento" name="fecha_nacimiento" class="form-control" value="{{ $beneficiario->fecha_nacimiento }}" required>
            </div>
            <div class="col-md-6">
                <label for="telefono" class="form-label">Teléfono</label>
                <input type="tel" id="telefono" name="telefono" class="form-control" value="{{ $beneficiario->telefono }}" placeholder="Número de Teléfono" required>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <input type="text" id="direccion" name="direccion" class="form-control" value="{{ $beneficiario->direccion }}" placeholder="Dirección" required>
            </div>
            <div class="col-md-4">
                ...
                <input type="text" id="codigo_postal" name="codigo_postal" class="form-control" value="{{ $beneficiario->codigo_postal }}" placeholder="Código Postal" required>
            </div>
            <div class="col-md-4">
                <label for="localidad" class="form-label">Localidad</label>
                <input type="text" id="localidad" name="localidad" class="form-control" value="{{ $beneficiario->localidad }}" placeholder="Localidad" required>
            </div>
            <div class="col-md-4">
            ...
            <div class="row g-3 mt-3">
                <div class="col-md-6">
                    ...
                    <input type="text" id="num_seguridad_social" name="num_seguridad_social" class="form-control" value="{{ $beneficiario->num_seguridad_social }}" placeholder="Número de la Seguridad Social" required>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" id="situacion_sanitaria" name="situacion_sanitaria" class="form-control" value="{{ $beneficiario->situacion_sanitaria }}" placeholder="Enfermedades, intervenciones quirúrgicas, etc." required>
                </div>
                <div class="col-md-6">
                    <label for="situacion_de_la_vivienda" class="form-label">Situación de la vivienda</label>
                    <input type="text" id="situacion_de_la_vivienda" name="situacion_de_la_vivienda" class="form-control" value="{{ $beneficiario->situacion_de_la_vivienda }}" placeholder="Barreras arquitectónicas,tipo de vivienda y ubicacion" required>
                </div>
                <div class="col-md-6">
                    <label for="situacion_economica" class="form-label">Situación económica</label>
                    <input type="text" id="situacion_economica" name="situacion_economica" class="form-control" value="{{ $beneficiario->situacion_economica }}" placeholder="Pensión, ingresos, ayudas... aportación al servicio" required>
                </div>
                <div class="col-md-6">
                    <label for="otros_recursos" class="form-label">Otros recursos a los que tiene acceso</label>
                    <input type="text" id="otros_recursos" name="otros_recursos" class="form-control" value="{{ $beneficiario->otros_recursos }}" placeholder="Centro de dia, de respiro familiar, ocupacional, SAD, etc" required>
                </div>
                <div class="col-md-6">
                    <label for="instalacion_de_terminal" class="form-label">Instalación de terminal/UCR</label>
                    <input type="text" id="instalacion_de_terminal" name="instalacion_de_terminal" class="form-control" value="{{ $beneficiario->instalacion_de_terminal }}" required>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" id="enfermedades" name="enfermedades" class="form-control" value="{{ $beneficiario->beneficiarioInteres->enfermedades }}" placeholder="Enfermedades">
                </div>
                <div class="col-md-6">
                    <label for="alergias" class="form-label">Alergias (opcional)</label>
                    <input type="text" id="alergias" name="alergias" class="form-control" value="{{ $beneficiario->beneficiarioInteres->alergias }}" placeholder="Alergias">
                </div>
                <div class="col-md-4">
                    <label for="medicacion_manana" class="form-label">Medicación Mañana (opcional)</label>
                    <input type="text" id="medicacion_manana" name="medicacion_manana" class="form-control" value="{{ $beneficiario->beneficiarioInteres->medicacion_manana }}" placeholder="Medicación Mañana">
                </div>
                <div class="col-md-4">
                    <label for="medicacion_tarde" class="form-label">Medicación Tarde (opcional)</label>
                    <input type="text" id="medicacion_tarde" name="medicacion_tarde" class="form-control" value="{{ $beneficiario->beneficiarioInteres->medicacion_tarde }}" placeholder="Medicación Tarde">
                </div>
                <div class="col-md-4">
                    <label for="medicacion_noche" class="form-label">Medicación Noche (opcional)</label>
                    <input type="text" id="medicacion_noche" name="medicacion_noche" class="form-control" value="{{ $beneficiario->beneficiarioInteres->medicacion_noche }}" placeholder="Medicación Noche">
                </div>
            </div>
            <div class="col-12">
                <label for="observaciones" class="form-label">Observaciones</label>
                <textarea id="observaciones" name="observaciones" class="form-control" rows="3">{{ $beneficiario->observaciones }}</textarea>
            </div>
        </div>
