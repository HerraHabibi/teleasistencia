...
<div class="register-wrapper d-flex justify-content-center align-items-center min-vh-75">
    <form method="POST" action="{{ route('register') }}" class="register-form p-5 rounded shadow" style="max-width: 600px; width: 100%;">
        ...
        <div class="form-row d-flex flex-wrap gap-4">
            <div class="form-group flex-fill" style="min-width: 45%;">
                ...
                <input id="name" type="text" name="name" class="form-control form-control-lg" placeholder="Nombre" required autofocus>
            </div>

            <div class="form-group flex-fill" style="min-width: 45%;">
                <label for="email" class="form-label fw-semibold text-secondary fs-4">Correo Electrónico</label>
                <input id="email" type="email" name="email" class="form-control form-control-lg" placeholder="Correo Electrónico" required>
            </div>
        ...
        <div class="form-group mt-4" style="max-width: 300px; margin: 2rem auto 0;">
            ...
            <input id="fecha_nacimiento" type="date" name="fecha_nacimiento" class="form-control form-control-lg" required>
        </div>
